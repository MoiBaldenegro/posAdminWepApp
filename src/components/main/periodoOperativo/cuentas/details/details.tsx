...
export default function NotesDetails({
  ...
  const transferIndex =
    element.transferHistory.length > 1 ? element.transferHistory.length - 1 : 0;
  useEffect(() => {
    console.log(element);
  });
  return (
    <div className={styles.screen}>
      <section className={styles.modal}>
        ...
        <div className={styles.sectionTwo}>
          <div className={styles.detailsContainer}>
            <div className={styles.detailsInOne}>
              ...
              <div className={styles.detailsContent}>
                ...
                <div className={styles.itemContainer}>
                  <h5>Mesa</h5>
                  {element.transferHistory.length > 0 ? (
          ...
          <div className={styles.detailsFirst}>
            <h2 className={styles.tableTittle}>Impresion de cuentas</h2>
            <table className={styles.table}>
              <thead>
                <tr>
                  <th className={styles.tHeadNote}>Folio</th>
